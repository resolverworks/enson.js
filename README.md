...
`npm i @namestone/enson` [&check;](https://www.npmjs.com/package/@namestone/enson)
...
```js
import { Record } from "@namestone/enson";
...
```js
import { Coin } from "@namestone/enson";
...
```js
import { Address } from "@namestone/enson";
...
```js
import { Chash } from "@namestone/enson";
...
```js
import { Node } from "@namestone/enson";
